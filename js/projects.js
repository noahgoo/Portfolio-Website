...
const PROJECTS = [
  ...
  },
  {
    ...
    category: "web",
    featured: true,
    image: "assets/images/kapoleitools.png",
    imageClass: "",
    imageStyle: "",
    tags: ["TypeScript", "Resend", "Vercel"],
    description:
      "Web app with multiple custom tools to improve efficiency in Kapolei CFA restaurant.",
    features: [
      "Tracker tool to track hold times of food items",
      "Waste report speeds up daily reporting by 5x",
      "Prep tool ensures accurate preparation of items during the day",
      "Analytics dashboards provide insights to tool collected data",
    ],
    links: [],
    href: "#",
  },
